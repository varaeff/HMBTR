...
- `PendingTieService` - обычные ничьи в группе и выявление ничьи за третьи места перед олимпийской сеткой;
...
Правило active-red: бойцы с активной красной карточкой видны в статистике standings, но исключаются из прохождения дальше и проверок ничьих там, где это влияет на дальнейший этап.
...
- самостоятельные CRUD/list маршруты для боев;
- вспомогательные функции для отправки счета боя;
...
Модуль соревнований владеет фиксацией результатов в жизненном цикле турнира. Модуль боев владеет общими операциями с данными боев и общими helper-функциями для отправки/оценки результатов.
