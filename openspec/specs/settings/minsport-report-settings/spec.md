# Ministry of Sport Report Settings Specification

## Purpose

Stores organization metadata that tournament staff will later reuse in a Ministry of Sport report flow that is not part of this capability.
